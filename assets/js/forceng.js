 ...
 * Author: Aditya Kotamraju @adityakotamraju
 * Version: 1.0
 */
angular.module('forceng', [])
  ...
  .factory('force', function ($rootScope, $q, $window, $http) {
    ...
    var loginURL = 'https://fsr--devr2.cs66.my.salesforce.com',
     ...
     */
    function describeLayout(objectName, recordTypeId) {
     ...
     * @param objectName
     */
    function getPickListValues(objectName){
        return request(
            {
                path: '/services/data/' + apiVersion + '/sobjects/' + objectName + '/describe'
            });
